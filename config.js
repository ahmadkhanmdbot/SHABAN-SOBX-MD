...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "SHABAN-SOBX-MD~bU1mQSCb#rHer5jrgyRQhQ_mZZ8rzKFAUdciGKKJShSB3XMtIDuE",
    ...
    STATUS_REPLY: process.env.STATUS_REPLY || "`ʏᴏᴜʀ sтαтυs sεεη by its AHMAD`",
